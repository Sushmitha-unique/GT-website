...
const Java2 = () => {
  return (
    <div>
      <div>
        <h1 className='webdev-h1'>WHY JAVA?</h1>
      </div>
      <div>
        <span className='webdev-span'>What is Java?</span>
      </div>
      ...
      <div className="container">
        <div className="webpage1-left">
          <h2 className="webdev-h2">Types of java</h2>
        ...
        <h3 className="webdev-h3">Why java?</h3>
        <ul className="list1">
