...
const Webpage1 = () => {
  return (
    <div>
      <div>
        <h1 className='webdev-h1'>WHY WEB DEVELOPMENT</h1>
      </div>
      <div>
        <span className='webdev-span'>What is Web Development?</span>
      </div>
      ...
      <div className="container">
        <div className="webpage1-left">
          <h2 className="webdev-h2">Types of Web Development</h2>
        ...
        <h3 className="webdev-h3">Why Web development?</h3>
        <ul className="list1">
